          ...
          {({ values, handleChange, handleSubmit, isSubmitting }) => (
            ...
            >
              ...
              <div className="relative">
                <textarea
                  ...
                  className="rounded-lg border border-gray-300
				   p-2 sm:p-3 pt-4 sm:pt-5 h-48 
				   resize-none text-sm sm:text-base focus:outline-none 
				   focus:ring-2 focus:ring-yellow-400 w-full peer placeholder-transparent"
                  required
                  placeholder="Message"
                />
                <label
              ...
              <button
                ...
                className="bg-yellow-500 text-white font-bold py-2 disabled:bg-gray-100 sm:py-3 text-sm sm:text-base rounded-lg shadow hover:bg-yellow-400 transition flex items-center justify-center gap-2"
              >
                {pendingSubmit && (
