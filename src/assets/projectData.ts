...
export const PythonProjects: ProjectDetails[] = [
	{
		...
		tasks: [
			...
			'Trained and evaluated multiple classification algorithms, including Logistic Regression, Random Forest, and Gradient Boosting.',
			'Conducted comprehensive model comparison using metrics such as accuracy, precision, recall, F1-score, and ROC–AUC.',
			'Random Forest was selected as the final model due to its superior ROC–AUC score.',
			'Utilized feature importance analysis to identify top predictors influencing accident likelihood.',
		],
		startDate: 'Feb 2024',
		endDate: 'Apr 2024',
		technologies: [
	...
	},
	{
		...
		tasks: [
			'Designed and implemented a facial recognition pipeline to improve recognition at extreme angles and long distances.',
			'Integrating StyleGAN3 (for image frontalization) with AdaFace (quality–adaptive margin loss).',
			'Conducted literature review and benchmarked against SOTA methods (ArcFace, CurricularFace, PFE, URL) to evaluate strengths and limitations of past facial recognition approaches.',
			'Applied DroneFace dataset (1,364 images, 11 subjects) with 5–fold cross–validation.',
			'Leveraged cosine similarity for feature comparison, ranking facial embeddings between drone images and portraits.',
			'Achieved a 66.6% rank–1 accuracy.',
		],
		startDate: 'Nov 2024',
		endDate: 'Dec 2024',
		technologies: [
